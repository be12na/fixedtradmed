...
<head>
    ...
    <style>
        body {
            ...
            height: 100vh;
            overflow: hidden;
            background-image: url("{{ asset('images/bg-neooptima.jpg') }}");
    ...
    <div class="vh-100 d-flex justify-content-center justify-content-md-end overflow-auto">
        <div class="register-container">
            <div class="register-box my-3 mx-2 m-md-0 py-2 px-3 py-md-3 px-md-5">
                ...
                <h4 class="text-center text-decoration-underline mb-1">Daftar Affiliate</h4>
                <div class="text-center mb-3">
                    <span class="me-2">Referral:</span>
                    <span class="fw-bold">{{ $referral->name }} ({{ $referral->username }})</span>
                </div>
                @include('partials.alert')
                <form method="POST" action="{{ route('referral-mitra.register', ['mitraReferral' => $referral->username]) }}">
                    @csrf
                    <div class="d-block mb-2">
                        <label>Username</label>
                        <input type="text" class="form-control" name="username" value="{{ old('username') }}" placeholder="Tanpa Spasi dan Tanpa Titik" autocomplete="off" required autofocus>
                    </div>
                    <div class="d-block mb-2">
                    ...
                    <div class="d-block mb-2">
                        ...
                        {{-- <input type="text" class="form-control" name="sub_domain" value="{{ old('sub_domain') }}" placeholder="Nama Domain" autocomplete="off" required> --}}
