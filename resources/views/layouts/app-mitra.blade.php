...
<head>
    ...
    <link rel="icon" sizes="32x32" href="{{ asset('images/favicon-32.png?t=' . mt_rand(1000001, 9999999)) }}"
        type="image/png">
    <link rel="icon" sizes="16x16" href="{{ asset('images/favicon-16.png?t=' . mt_rand(1000001, 9999999)) }}"
        type="image/png">
    <link rel="shortcut icon" href="{{ asset('images/favicon-32.png?t=' . mt_rand(1000001, 9999999)) }}"
        type="image/x-icon">
...
<body class="@yield('bodyClass')">
    @include('layouts.sidebars.mitra')
    <div class="content">
        <div class="content-header shadow-sm">
            @include('layouts.navbars.mitra')
            <div
