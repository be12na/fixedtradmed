@php
    $canEdit = hasPermission('main.settings.bonus.mitraPremiumShopping.edit');
...
<div class="d-block text-center p-3 border rounded-3 bg-gray-100">
    ...
    @if ($canEdit)
    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#my-modal-sm" data-modal-url="{{ route('main.settings.bonus.mitraPremiumShopping.edit', ['settingBonusMitraShoppingTarget' => $routeKey]) }}" title="Edit">
