<form class="modal-content" method="POST" action="{{ route('main.settings.mitra.purchase.discount.update') }}" id="myForm" data-alert-container="#alert-form-container">
    ...
    <div class="modal-body">
        @if ($showSubmit)
            ...
            <div class="d-block mb-2">
                <label class="d-block required">Minimal Belanja</label>
