...
<div class="modal-content">
                    ...
                    <tbody class="border-top-0">
                        ...
                        @foreach ($productDetails as $detail)
                            ...
                            <tr>
                                ...
                                <td class="text-center">@formatNumber($detail->product_qty) {{ $detail->product_unit_sale }}</td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td class="fw-bold text-end">
                                @formatCurrency($branchSale->sum_total_price, 0, true)
                            </td>
                        </tr>
                    </tfoot>
                </table>
    ...
    <div class="modal-footer @if($isDelete === true) justify-content-between @endif py-1 px-3">
        @if($isDelete === true)
        <form method="POST" action="{{ route('member.sale.destroy', ['branchSaleModifiable' => $branchSale->id]) }}" data-alert-container="#alert-delete-container">
            @csrf
