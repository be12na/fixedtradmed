...
<form class="d-block" method="POST" action="{{ route('member.sale.update', ['branchSaleModifiable' => $data->id]) }}" id="myForm" data-alert-container="#alert-container">
    @csrf
            ...
            <table class="table table-sm table-striped table-nowrap mb-2">
                ...
                <tbody id="table-items" class="small border-top-0">
                    ...
                    @foreach ($data->products as $saleItem)
                        @include('member.sales.sale-items', [
